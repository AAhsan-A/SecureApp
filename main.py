...
class MyApp(App):
    ...
    def build(self):
        ...
        # Add a welcome label
        welcome_label = Label(text='Welcome to SecureApp', font_size='24sp', size_hint=(1, 0.2), color=(0, 0, 0, 1))
        content_layout.add_widget(welcome_label)

        # Add a description label
        description_label = Label(text='Please enter your username and password to continue.', font_size='18sp', size_hint=(1, 0.2), color=(0, 0, 0, 0.7))
